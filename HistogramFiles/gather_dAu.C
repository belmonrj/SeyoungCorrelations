void gather_dAu()
{
  ...
  TFile* file_CNT_BBCN = TFile::Open("dAu_pT_CorHisto_CNT_BBCN.root");
  TFile* file_CNT_BBCS = TFile::Open("dAu_pT_CorHisto_CNT_BBCS.root");
  TFile* file_CNT_FVTN = TFile::Open("dAu_pT_CorHisto_CNT_FVTN.root");
  TFile* file_CNT_FVTS = TFile::Open("dAu_pT_CorHisto_CNT_FVTS.root");

  TFile* file_BBCN_BBCS = TFile::Open("dAu_pT_CorHisto_BBCN_BBCS.root");
  TFile* file_BBCN_FVTN = TFile::Open("dAu_pT_CorHisto_BBCN_FVTN.root");
  TFile* file_BBCN_FVTS = TFile::Open("dAu_pT_CorHisto_BBCN_FVTS.root");

  TFile* file_FVTN_BBCS = TFile::Open("dAu_pT_CorHisto_FVTN_BBCS.root");
  TFile* file_FVTN_FVTS = TFile::Open("dAu_pT_CorHisto_FVTN_FVTS.root");
  TFile* file_FVTS_BBCS = TFile::Open("dAu_pT_CorHisto_FVTS_BBCS.root");
  ...
  TFile* fSeyoung = new TFile("seyoung_data_dau.root","recreate");
